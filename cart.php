...
<br/>
	<div class="product-list">
		...
		<table>
			...
			<tr>
				...
				<td align="right">    <?php printf('$ %0.2f', $price1); ?></td>
				<td align="right">    <?php printf ('$ %0.2f', $qty1 * $price1); ?></td>
				<td>
					<table>
					<tr>
						<td>Remove</td>
			...
			<tr>
				...
				<td align="right">   <?php printf('$ %0.2f', $price2); ?></td>
				<td align="right">   <?php printf ('$ %0.2f', $qty2 * $price2); ?></td>
				<td>
					<table>
					<tr>
						<td>Remove</td>
			...
			<tr>
				...
				<td align="right">    <?php printf('$ %0.2f', $price3); ?></td>
				<td align="right">    <?php printf ('$ %0.2f', $qty3 * $price3); ?></td>
				<td>
					<table>
					<tr>
						<td>Remove</td>
	...
	<div id="footer">
		<div class="footer">
			Copyright &copy; 2016 sweetscomplete.com. All rights reserved. <br/>
