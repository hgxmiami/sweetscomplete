...
//isset function is saying if it has a variable cast it to an (int),grabs the value of $page
...
<div id="rightnav">
	...
	<div class="product-list">
		<h2>Our Products</h2>
		<a class="pages" href="products.php?page=<?php echo $prev;
        ?>">&lt;prev</a>
        <!--this portion is the one that generates the browser going from previous to next. Actually outputting in our URL
        what the browser is doing. -->
		&nbsp;|&nbsp;
		<a class="pages" href="products.php?page=<?php echo $next;
        ?>">next&gt;</a>
			<ul>
                <?php echo $view->displayProducts($page, $linesPerPage, $maxProducts, 
